...
def run_single_file(args):
        ...
        # Build the full path to the Fonts folder
        fonts_folder_path = os.path.join(script_dir, 'Fonts')
        # Get a list of all font files in that folder
        font_files = os.listdir(fonts_folder_path)
        # Choose a random font file name from the list
        random_font_file = random.choice(font_files)
        # Join the folder path and the file name to get the full path to the chosen font
