...
def generalized_box_iou(box1, box2):
    """
    Calculate Generalized Intersection over Union (GIoU) of two bounding boxes.
    """
...
def complete_box_iou(box1, box2):
    """
    Calculate Complete Intersection over Union (CIoU) of two bounding boxes.
    This also implicitly calculates DIoU.
    """
    iou = box_iou(box1, box2)
